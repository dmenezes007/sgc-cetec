            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
                <div className="bg-slate-800 p-6 rounded-lg shadow-md">
                    ...
                    <ResponsiveContainer width="100%" height={700}>
                        <BarChart data={valorPorLinha} layout="vertical" style={{fontFamily: 'Open Sans, sans-serif'}} margin={{ top: 20, right: 30, left: 20, bottom: 5 }} onClick={handleChartClick} barSize={80} barCategoryGap={30}>
                ...
                <div className="bg-slate-800 p-6 rounded-lg shadow-md">
                    ...
                    <ResponsiveContainer width="100%" height={700}>
                        <BarChart data={quantidadePorLinha} layout="vertical" style={{fontFamily: 'Open Sans, sans-serif'}} margin={{ top: 20, right: 30, left: 20, bottom: 5 }} onClick={handleChartClick} barSize={80} barCategoryGap={30}>
                            <CartesianGrid strokeDasharray="3 3" horizontal={false} stroke="#334155" />
                            <XAxis type="number" tick={{ fontSize: 12, fill: '#94a3b8' }} axisLine={false} tickLine={false} />
                            <YAxis type="category" dataKey="name" tick={{ fontSize: 12, fill: '#94a3b8' }} axisLine={false} tickLine={false} width={300} />
