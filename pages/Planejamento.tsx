...
const Planejamento: React.FC = () => {
    ...
    const filteredContratacoes = useMemo(() => {
        return contratacoes.filter(c => {
            ...
            return unidadeMatch && statusMatch;
        });
    }, [contratacoes, filterUnidade, filterStatus]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <div className="bg-slate-800 p-6 rounded-lg shadow-md">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={custoPorUnidade} style={{fontFamily: 'Open Sans, sans-serif'}}>
                ...
                <div className="bg-slate-800 p-6 rounded-lg shadow-md">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={vagasPorUnidade} style={{fontFamily: 'Open Sans, sans-serif'}}>
                            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#334155" />
                            <XAxis dataKey="name" tick={{ fontSize: 12, fill: '#94a3b8' }} axisLine={false} tickLine={false} />
                            <YAxis tick={{ fontSize: 12, fill: '#94a3b8' }} axisLine={false} tickLine={false} />
                            <Tooltip contentStyle={{ backgroundColor: '#1e293b', border: '1px solid #334155' }} cursor={{ fill: 'rgba(204, 204, 204, 0.5)' }} />
